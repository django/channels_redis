...
class BaseMessageSerializer(abc.ABC):
    ...
    def _setup_encryption(
        self,
        symmetric_encryption_keys: "Optional[Union[Iterable[Union[str, ReadableBuffer]], str, bytes]]",
    ):
        ...
        keys = cast("Iterable[Union[str, ReadableBuffer]]", symmetric_encryption_keys)
    ...
    def make_fernet(self, key: "Union[str, ReadableBuffer]") -> "Fernet":
        """
